 ...
 */
public class MLPRegressionExample12 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Layer bn1     = new BatchNormLayer(30);
        Layer dp1     = new DropoutLayer(0.8, /*seed=*/42, /*size=*/30);
        Layer hidden2 = initLayer(15, 30, rnd, ActivationFunctions.RELU);
        Layer bn2     = new BatchNormLayer(15);
        Layer dp2     = new DropoutLayer(0.8, 42, 15);
        Layer output  = initLayer(1, 15, rnd, ActivationFunctions.IDENTITY);
        MultiLayerPerceptronProcessor mlp =
            new MultiLayerPerceptronProcessor(List.of(hidden1, bn1, dp1, hidden2, bn2, dp2, output));

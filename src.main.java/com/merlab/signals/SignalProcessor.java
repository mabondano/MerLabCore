...
public class SignalProcessor {
     ...
     */
    public static List<Double> addSignals(List<Double> a,
                                          List<Double> b,
                                          LengthMode mode) {
     ...
     */
    public static List<Double> convolveReversed(List<Double> signal,
                                                List<Double> kernel,
                                                int stride) {
        if (stride < 1) {
    ...
    //convolve
    public static List<Double> convolve(List<Double> signal, List<Double> kernel) {

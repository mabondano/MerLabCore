...
import com.merlab.signals.SignalProvider;
...
public class Main {
    public static void main(String[] args) {
        ...
        // Stride = 1
        List<Double> conv1 = SignalProcessor.convolveReversed(sig3, kernel, 1);
        ...
        // Stride = 2
        List<Double> conv2 = SignalProcessor.convolveReversed(sig3, kernel, 2);
